...
public class IA {
	...
	/**
	 * Method <b>IAgenSearch</b>, genera la direcció cap a on dispararà en funció de la posició del vaixell trobat.
	...
	/**
	 * Method <b>IAcol</b>, modifica el valor de la columna emmagatzemada a la memòria en funció a la direcció, en aquet cas modifica la columna si la direcció és 0 o 1 (Dreta o Esquerra).
	...
	/**
	 * Method <b>IAfila</b>, modifica el valor de la fila emmagatzemada a la memòria en funció a la direcció, en aquest cas modifica la fila si la direcció és 2 o 3 (Abaix o Adalt).
	...
	/**
	 * Method <b>ReCol</b>, busca la següent part del vaixell a enfonsar, partint de alguna part del mateix vaixell ja descobert, horitzontalment.
	...
	/**
	 * Method <b>ReFila</b>, busca la següent part del vaixell a enfonsar, partint de alguna part del mateix vaixell ja descobert, verticalment.
	 * @param mat Taulell sobre el que treballa.
	 * @param fila Indica la fila on treballa.
	 * @param col Indica la columna on treballa.
	 * @param buscar Indica la posició cap a on buscara una celda buida/sense descobrir.
